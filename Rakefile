...
desc 'Knife upload dockerserver cookbook to test environment'
task :upload_test do
  sh 'knife cookbook upload -o .. dockerserver -E test --force'
end

desc 'Knife upload dockerserver cookbook to prod environment'
task :upload_prod do
  sh 'knife cookbook upload -o .. dockerserver -E prod'
end
